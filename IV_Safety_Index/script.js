  ...
  // lat/lon coordinates into screen coordinates
    ...
    d3.json('world.topojson', function(error, data) {
      ...
      d3.csv('Crime_Dataset.csv', function(error, crime_data) {
        ...
        // Example usage
        //console.log(nToRadius(500)); // outputs 5.5
  
        //console.log(nMinAndMax);

        //scale: domain and a range
        /*var nToRadius = d3.scaleSqrt()
                            .domain(nMinAndMax)
                            .range([1,10]); */
        ...
        g.selectAll('circle')
          ...
          .attr("stroke",function(d){
           ...
           .attr("fill-opacity",function(d){
                if (+d.Rank > 350){
                    return 0.7
                }else if (+d.Rank > 250 && +d.Rank < 350) return 0.4
                else return 0.2
            })
           .on("mouseover", function (d) {
            ...
            d3.select('#safety').text(d.Safety_Index);
            d3.select('#tooltip')
